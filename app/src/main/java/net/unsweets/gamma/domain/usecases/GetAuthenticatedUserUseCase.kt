...
class GetAuthenticatedUserUseCase(val pnutRepository: IPnutRepository, val preferenceRepository: IPreferenceRepository): UseCase<GetAuthenticatedUserOutputData, Unit>() {
